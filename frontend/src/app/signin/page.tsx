                ...
                <form className="my-2" onSubmit={handleSubmit}>
                    ...
                    <LabelInputContainer className="mb-4">
                        ...
                        <Input id="password" placeholder="••••••••" type="password"
                            style={{ backgroundColor: 'rgb(25 19 47)', color: 'white' }}
                        />
                         <div className="forget_set_ui"><a href="/forget-password">Forget passord</a></div>
                    </LabelInputContainer>
                    ...
                    <div className="other_options">If you dont have account  <a href="/signup">Sign up</a></div>
                </form>
            </div>
        </div>
    );
