    ...
    return (
        <div className="wrpe_form flex items-center justify-center h-screen">
            <div className="max-w-md w-full mx-auto rounded-md p-4 md:p-8 bg-white/20 dark:bg-black/70 backdrop-blur-lg">
                <h2 className="font-bold text-xl text-white/90 dark:text-neutral-200"
                    style={{
                        fontSize : '18px',
                        fontWeight : '500',
                        marginBottom : '18px',
                        textDecoration : 'underline wavy #a9a5bb',
            ...
            {/* <p className="text-neutral-600 text-sm max-w-sm mt-2 dark:text-neutral-300">
                ...
                <LabelInputContainer className="mb-4">
                    ...
                    <div className="other_options">Back to login  <a href="/signup">Sign up</a></div>
                </form>
            </div>
        </div>
    );
